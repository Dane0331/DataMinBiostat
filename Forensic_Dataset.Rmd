...
tsne_plot + theme(legend.position = "none")|umap_plot
```
...
```{r matrix maplot, message=FALSE, warning=FALSE}
...
```{r volcano plot generation, message=FALSE, warning=FALSE}
...
```{r heatmap data prep, message=FALSE, warning=FALSE}
# Heatmap
...
```{r heatmap generation, message=FALSE, warning=FALSE}
# Generate heatmap
...
```{r tissue filtering, message=FALSE, warning=FALSE}
# ======= Filtering for Tissue Specific Sites =======
